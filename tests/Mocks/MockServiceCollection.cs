			...
			if (serviceDescriptors != null)
			{
				foreach (ServiceDescriptor serviceDescriptor in serviceDescriptors)
				{
					if (serviceDescriptor.ImplementationInstance != null &&
						serviceDescriptor.ImplementationInstance.GetType().Equals(typeof(MockNotificationService)))
					{
						_notificationService = serviceDescriptor.ImplementationInstance as MockNotificationService;
					}
