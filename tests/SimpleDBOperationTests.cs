...
namespace SimpleDB.Tests
{
    ...
    public class SimpleDBOperationTests : BaseTest
    {
        [TestMethod]
        public void Construct_ValidInstance_Success()
        {
            ...
            try
            {
                ...
                using ISimpleDBOperations<MockRow> sut = CreateTable<MockRow>(initializer, null, ref walTableAccessor, ref watermarkAccessor);
        ...
        public void Initialize_InvalidParam_ForeignKeyManagerNull_Throws_ArgumentNullException()
        {
            ...
            try
            {
                io.Directory.CreateDirectory(directory);
                SimpleDBManager initializer = CreateTestInitializer(directory);
                new SimpleDBOperations<MockRow>(initializer, null, new MockTransactionManager(), null, null);
            }
            finally
            {
        ...
        public void Insert_SingleRecord_ForcedWrite_Success()
        {
            ...
            try
            {
                ...
                IWatermarkAccessor watermarkAccessor = null;
                using (SimpleDBOperations<MockRow> sut = CreateTable<MockRow>(initializer, null, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using ISimpleDBOperations<MockRow> sutRead = CreateTable<MockRow>(initializer, null, ref walTableAccessor, ref watermarkAccessor);
        ...
        public void Insert_SingleRecord_LazyWrite_Success()
        {
            ...
            try
            {
                ...
                IWatermarkAccessor watermarkAccessor = null;
                using (ISimpleDBOperations<MockLazyWriteRow> sut = CreateTable<MockLazyWriteRow>(initializer, null, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using ISimpleDBOperations<MockLazyWriteRow> sutRead = CreateTable<MockLazyWriteRow>(initializer, null, ref walTableAccessor, ref watermarkAccessor);
        ...
        public void Insert_SingleRecord_OtherRecordsExist_Success()
        {
            ...
            try
            {
                ...
                IWatermarkAccessor watermarkAccessor = null;
                using (ISimpleDBOperations<MockRow> sut = CreateTable<MockRow>(initializer, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    sut.Insert(new MockRow());
                    sut.Insert(new MockRow());
                }

                using ISimpleDBOperations<MockRow> sutRead = CreateTable<MockRow>(initializer, keyManager, ref walTableAccessor, ref watermarkAccessor);
                IReadOnlyList<MockRow> records = sutRead.Select();
        ...
        public void Delete_SingleRecord_RecordIsRemoved_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockRow> sut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using (SimpleDBOperations<MockRow> deleteSut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using (ISimpleDBOperations<MockRow> readSut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
        ...
        public void Delete_Multiple_RecordIsRemoved_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockRow> deleteSut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(15168, deleteSut.RecordCount);
                    Assert.AreEqual(1475355, deleteSut.DataLength);
        ...
        public void Update_SingleRecord_ObjectAlreadydisposed_Throws_ObjectDisposedException()
        {
            ...
            try
            {
                ...
                using ISimpleDBOperations<MockUpdateRow> sut = CreateTable<MockUpdateRow>(initializer, keyManager, ref walTableAccessor, ref watermarkAccessor);
                sut.Dispose();
        ...
        public void Update_SingleRecord_RecordIsUpdated_Success()
        {
            ...
            try
            {
                ...
                using (SimpleDBOperations<MockUpdateRow> sut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    sut.OnAction += (simpleDb) => onActionCalled = true;
                ...
                using (SimpleDBOperations<MockUpdateRow> updateSut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using (SimpleDBOperations<MockUpdateRow> readSut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
        ...
        public void Update_Multiple_RecordIsUpdated_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockUpdateRow> sut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    List<MockUpdateRow> testData = [];
                ...
                using (ISimpleDBOperations<MockUpdateRow> updateSut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(15168, updateSut.RecordCount);
                    Assert.AreEqual(1657371, updateSut.DataLength);
                ...
                using (ISimpleDBOperations<MockUpdateRow> readSut = CreateTable<MockUpdateRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(15168, readSut.RecordCount);
        ...
        public void Insert_Multiple_Writes15168Records_Success()
        {
            ...
            try
            {
                ...
                using (SimpleDBOperations<MockRow> sut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    List<MockRow> testData = [];
                ...
                using (SimpleDBOperations<MockRow> readSut = CreateTable<MockRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(15168, readSut.RecordCount);
        ...
        public void Insert_Multiple_Writes15168Records_Compressed_Success()
        {
            ...
            try
            {
                ...
                using (SimpleDBOperations<MockRowCompressed> sut = CreateTable<MockRowCompressed>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                ...
                using (SimpleDBOperations<MockRowCompressed> readSut = CreateTable<MockRowCompressed>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(15168, readSut.RecordCount);
        ...
        public void Select_ById_RecordFoundAndReturned_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockRowCompressed> sut = CreateTable<MockRowCompressed>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    List<MockRowCompressed> testData = [];
                ...
                using (ISimpleDBOperations<MockRowCompressed> readSut = CreateTable<MockRowCompressed>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
        ...
        public void InsertOrUpdate_UpdateMultipleNewRows_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockTableUserRow> mockUsers = CreateTable<MockTableUserRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    ...
                    using (ISimpleDBOperations<MockTableAddressRow> sut = CreateTable<MockTableAddressRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                    {
                    ...
                    using (ISimpleDBOperations<MockTableAddressRow> readSut = CreateTable<MockTableAddressRow>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                    {
                        Assert.AreEqual(5, readSut.RecordCount);
        ...
        public void Insert_IndexSpansMultipleProperties_Success()
        {
            ...
            try
            {
                ...
                using (ISimpleDBOperations<MockRowMultipleIndex> sut = CreateTable<MockRowMultipleIndex>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    for (int i = 0; i < 5; i++)
                        sut.InsertOrUpdate(new MockRowMultipleIndex() { Name = $"Name {i}", Index = i });
                }

                using (ISimpleDBOperations<MockRowMultipleIndex> readSut = CreateTable<MockRowMultipleIndex>(simpleDBManager, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
                    Assert.AreEqual(5, readSut.RecordCount);
        ...
        public void Validate_DataWrittenToDisk_Success()
        {
            ...
            try
            {
                ...
                using (SimpleDBOperations<MockRow> sut = CreateTable<MockRow>(initializer, keyManager, ref walTableAccessor, ref watermarkAccessor))
                {
