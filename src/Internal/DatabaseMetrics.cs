...
{
    internal sealed class DatabaseMetrics : IDatabaseMetrics
    {
        ...
        public DatabaseMetrics(ISimpleDBManager simpleDBManager, ITransactionManager transactionManager)
        {
            _simpleDBManager = simpleDBManager ?? throw new ArgumentNullException(nameof(simpleDBManager));
            _transactionManager = transactionManager ?? throw new ArgumentNullException(nameof(transactionManager));
        }

        public ITransactionMetrics TransactionMetrics => _transactionManager;

        public Dictionary<string, ITableMetrics> TableMetrics
        {
            get
            {
                Dictionary<string, ITableMetrics> Result = [];
